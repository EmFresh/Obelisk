...
public class TutorialState2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (state == tutorialState.learnMovementStage2)
        {
            ...
            if (Waypoint.touchedWaypoint2)
            {
                ...
                myPool.SpawnObject("Resource(StoneSmall)", new Vector3(-85, 0.5f, -14), transform.rotation);
                myPool.SpawnObject("Resource(CrystalSmall)", new Vector3(-82, 0.5f, -14), transform.rotation);
                UI7.SetActive(false);
                UI2.SetActive(true);
        ...
        if (state == tutorialState.learnPickupSmall)
        {
            ...
            if (PlayerPickup.StoneAmount >= 1 && PlayerPickup.WoodAmount >= 1 && PlayerPickup.CrystalAmount >= 1)
            {
                ...
                myPool.SpawnObject("Resource(Wood)", new Vector3(-89, 0.5f, -23), transform.rotation);
                myPool.SpawnObject("Resource(Stone)", new Vector3(-85, 0.5f, -23), transform.rotation);
                myPool.SpawnObject("Resource(Crystal)", new Vector3(-81, 0.5f, -23), transform.rotation);
                UI2.SetActive(false);
                UI3.SetActive(true);
